...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Plot fluence in the zy plane %%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Fzy = reshape(F(Nx/2,:,:),Ny,Nz)';

iy = round((cfg.binsize*Ny/2 + 0.15)/cfg.binsize);
iz = round(zs/cfg.binsize);
zzs  = zs;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Plot deposition in the zx plane %%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

Fzx = reshape(F(:,Ny/2,:),Nx,Nz)'; % in z,x plane through source
mua = cfg.muav(reshape(T(:,Ny/2,:),Nx,Nz)');
Azx = Fzx.*mua;
